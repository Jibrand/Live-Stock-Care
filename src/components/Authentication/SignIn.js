...
function App() {
  ...
  const [firsta21, setfirsta21] = useState('')
        ...
        <MDBRow>
          <MDBCol sm="6">
            ...
            <div className="d-flex flex-column justify-content-center h-custom-2 w-75">
              ...
              <MDBInput wrapperClass="mb-2 mx-5 w-100" placeholder='Password' label=" " type="password" size="lg" value={password} onChange={(e) => setPassword(e.target.value)} disabled={loading} />

              <Button className="logo-button mb-4 px-5 mx-5 w-100" style={{ backgroundColor: 'black', justifyContent: 'center', color: "white" }} variant="contained" onClick={handleLogin} disabled={loading}>
                {loading ? `${t('l10')}` : `${t('l14')}`}
              </Button>
