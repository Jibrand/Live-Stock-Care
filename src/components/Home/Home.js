    ...
    {/* cards */}
      ...
      <MDBRow className="text-center">
        <MDBCol md="3" className="mb-5 mb-md-0">
          ...
          <h6 style={{ color: 'Black' }}>{t('b1_7')}</h6>
        ...
        <MDBCol md="3" className="mb-5 mb-md-0">
          ...
          <h6 style={{ color: 'Black' }}> {t('b1_8')}</h6>
        ...
        <MDBCol md="3" className="mb-5 mb-md-0">
          ...
          <h6 style={{ color: 'Black' }}> {t('b1_9')}</h6>
        ...
        <MDBCol md="3" className="mb-5 mb-md-0">
          ...
          <h6 style={{ color: 'Black' }}> {t('b1_10')}</h6>
      ...
      <Container fluid className="footerabout sm:mt-6  mt-[1000px]" >
        <Row>
          ...
          <Col md="3" className="footer-copywrightq sm:mt-0 mt-10">
            ...
            <h3 style={{ textAlign: "center" }}><><></></>Greenway Plaza #1320.</h3>
