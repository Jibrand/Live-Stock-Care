                                        ...
                                        <MDBCol lg="4" className="bg-grey" style={{ backgroundColor: "#ddd4e8" }}>
                                            <div className="p-5">
                                                ...
                                                <div className="d-flex justify-content-between mb-4">
                                                    ...
                                                    <MDBTypography className="font-family-numbers" tag="h6"> Rs {totalPrice}</MDBTypography>
                                                </div>
                                                ...
                                                <div className="d-flex justify-content-between mb-5">
                                                    ...
                                                    <MDBTypography className="font-family-numbers" tag="h5">Rs {totalPrice}</MDBTypography>
                                                </div>
                                                ...
                                                }} onClick={handleModalButtonClick} variant="contained">
                                                    Pay Now
                                                </Button>
                                                ...
                                                <div className={`modal ${isModalOpen ? 'show' : ''}`} onClick={toggleModal}>
                                                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                                                        ...
                                                        <Button style={{
                                                            backgroundColor: '#350076',
                                                        }} onClick={handleNext} variant="contained"> Continue </Button>
                                                    </div>
                                                </div>
